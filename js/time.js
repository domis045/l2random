...
var current="<div id='asd' style='text-align:center;margin-left:30px;'>Server started</div>";        //—>enter what you want the script to display when the target date and time are reached, limit to 20 characters
...
document.getElementById('count2').style.width="277px";
